// ShoppingMall.dart
import 'Product.dart';
import 'dart:io'; // 콘솔 입출력을 위해 사용합니다.

class ShoppingMall {
  // 판매하는 상품 목록과 장바구니의 총 가격을 속성으로 가집니다.
  ...
  // 생성자: 초기 상품 목록을 추가합니다.
  ShoppingMall() {
    // products 리스트에 Product 객체를 추가합니다.
    products
    ...
    // add 메서드는 리스트에 새로운 요소를 추가하는 데 사용됩니다.
    ...
    Product 클래스 생성자에서 named parameters를 사용한 경우(required this.name처럼) 생성자 정의를 유지하고 객체를 생성할 때 인자의 이름을 명시해 호출해야 한다.
  ...
  void addToCart() {
    ...
    String? productName = stdin.readLineSync(); // 사용자가 입력한 상품 이름을 저장
